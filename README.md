...
# Demo/Results
Generated RF signals in matlab via code and simulink blocks were transmitted and successfully received at the SDR receiver upon which the IQ data was extracted and later pasted into the web interface for classification.
